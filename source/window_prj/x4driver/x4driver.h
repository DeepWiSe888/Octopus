...
typedef struct
{
    ...
    uint8_t _spi_buffer[SPI_BUFFER_SIZE];
    uint8_t* spi_buffer;
 ...
 * @return Status of execution as defined in x4driver.h
 */
int x4driver_set_predefined(X4Driver_t* x4driver, X4DriverCallbacks_t* x4driver_callbacks, X4DriverLock_t *lock, X4DriverTimer_t *timer, X4DriverTimer_t *timer_action, void* user_reference);
