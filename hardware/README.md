...
If pm denotes the coordinates of the mth Tx antenna (m = 0, 1, ...N<sub>TX</sub>), and qn denotes the coordinates of the nth RX antenna (n = 0, 1, 2, …N<sub>RX</sub>), then the location of the virtual antennas can be computed as pm+qn, for all possible values of m and n. For example in Figure 5, p1 = 0 and p2 = 4, and q1 = 0, q2 = 1, q3 = 2, and q4 = 3 (where the coordinates are expressed in units of d, and the Tx1 (respectively Rx1) is assumed to be the origin for the Tx (respectively, Rx) antennas.
